...
const getResponsiveLoaderOptions = ({
  ...
  if (!adapter && detectedLoaders.responsiveAdapter) {
    adapter = require(path.join(path.dirname(detectedLoaders.responsive), 'adapters', detectedLoaders.responsiveAdapter)); // eslint-disable-line
  }
